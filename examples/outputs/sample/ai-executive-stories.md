...
Migration complexity is **Medium**. The current evidence shows **1** scope-reduction candidates and **12** risk flags. The financial story is cost avoidance through retiring low-value customizations, rationalizing reports, and avoiding unnecessary history migration.
