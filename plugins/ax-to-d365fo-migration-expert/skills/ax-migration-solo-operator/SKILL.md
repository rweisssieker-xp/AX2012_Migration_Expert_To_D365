---
name: ax-migration-solo-operator
description: Use when solo AX to D365FO migration operation, end-to-end guided migration, autonomous project steering, or single-user migration command center needs.
---
