---
name: ax-migration-project-drift-detector
description: Use when detecting project drift, scope creep, missing decisions, timeline risk, budget drift, or gate slippage.
---
