---
name: ax-migration-process-owner-validator
description: Use when process owner validation, business owner sign-off, fit-gap validation, standard process approval, or process acceptance needs.
---

# Process Owner Validator
