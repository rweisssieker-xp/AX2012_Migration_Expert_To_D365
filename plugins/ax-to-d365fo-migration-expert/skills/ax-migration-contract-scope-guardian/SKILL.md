---
name: ax-migration-contract-scope-guardian
description: Use when migration work needs contract, scope, SOW, change request, commercial guardrails, approval paths, and scope creep prevention.
---

# ax-migration-contract-scope-guardian

## Purpose

Use this skill to turn AX to D365FO migration evidence into autonomous governance outputs for contract, scope, SOW, change request, commercial guardrails, approval paths, and scope creep prevention.
