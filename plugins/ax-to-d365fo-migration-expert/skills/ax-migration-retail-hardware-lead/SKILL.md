---
name: ax-migration-retail-hardware-lead
description: Use when retail hardware, POS devices, scanners, receipt printers, cash drawers, payment terminals, store network, or device readiness needs.
---

# Retail Hardware Lead
