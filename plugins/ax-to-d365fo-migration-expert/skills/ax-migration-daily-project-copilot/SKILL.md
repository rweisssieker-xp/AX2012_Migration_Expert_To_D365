---
name: ax-migration-daily-project-copilot
description: Use when daily migration command sheet, next actions, daily standup, blockers, decisions, or project rhythm needs.
---

# Daily Project Copilot
