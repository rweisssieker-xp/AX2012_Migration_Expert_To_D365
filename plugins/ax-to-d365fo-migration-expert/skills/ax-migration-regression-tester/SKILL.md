---
name: ax-migration-regression-tester
description: Use when regression testing, end-to-end testing, retesting, risk-based regression suite, or repeat validation needs.
---
