---
name: ax-migration-decision-impact-simulator
description: Use when simulating migration decisions, scope choices, cost, timeline, risk, cutover, support, or what-if migration scenarios.
---
