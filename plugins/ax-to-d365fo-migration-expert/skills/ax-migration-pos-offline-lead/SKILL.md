---
name: ax-migration-pos-offline-lead
description: Use when POS offline, offline DB, offline sync, offline payments, conflict handling, store offline continuity, or recovery planning needs.
---
