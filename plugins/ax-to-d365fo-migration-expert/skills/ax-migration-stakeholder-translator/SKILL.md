---
name: ax-migration-stakeholder-translator
description: Use when translating migration evidence for CEO, CFO, COO, CIO, CISO, PMO, key users, testers, support, legal, or delivery teams.
---
